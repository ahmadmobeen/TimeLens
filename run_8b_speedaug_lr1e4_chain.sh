#!/usr/bin/env bash
# TimeLens-8B replication of the paper's speedaug supply arm, at the adapter rate 1e-4.
...
ARM_ANNO=data/charades_full/charades_train_speedaug.json
OUT_ROOT=output/TimeLens-8B/a6_speedaug_8b_lr1e4
PREFIX=a6_speedaug_8b_lr1e4
LOG=logs/8b_speedaug_lr1e4
EXPECT=3363
NSHARD=4
